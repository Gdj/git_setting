...
----
  - [Git 설치 세팅](#git-설치-세팅) 
  - [저장소 만들기](#저장소-만들기) 
    + [깃허브 저장소 만들기](#깃허브-저장소-만들기) 
    + [로컬 저장소 만들기](#로컬-저장소-만들기)
      * [로컬 디렉토리 저장소 만들어 원격저장소에 올리기](#로컬-디렉토리-저장소-만들어-원격저장소에-올리기)
      * [기존 원격 저장소 clone하기](#기존-원격-저장소-clone하기)
      * [기존 원격 저장소 계정으로 clone하기](#기존-원격-저장소-계정으로-clone하기)
  - [깃 기본작업](#깃-기본작업) 
    + [원격 저장소 clone](#원격-저장소-clone)
    + [로컬무시하고 원격 저장소 받아오기](#로컬무시하고-원격-저장소-받아오기)
    + [원격 저장소에서 받아오기 ](#원격-저장소에서-받아오기)
    + [원격 저장소에서 특정 폴더만 받아오기](#원격-저장소에서-특정-폴더만-받아오기)
    + [파일 추가 & 변경 원격 저장소 올리기](#파일-추가--변경-원격-저장소-올리기)
  - [branch](#branch) 
    + [가지치기 (branch) 기본기능](#가지치기-branch-기본기능) 
...
### 로컬무시하고 원격 저장소 받아오기
  #### Stash를 이용하는 방법 
  - 임시보간후, 원격 저장소 내용가져오기
  - 로컬 변경사항 임시저장 : `git stash`
  - 원격 저장소에서 최신 내용 가져오기 : `git pull`
  - 임시 저장한 변경사항 적용 (선택 사항): `git stash pop` 
  #### Reset을 이용하는 방법
  - 로컬 파일의 변경사항을 완전히 삭제하고, 원격 저장소의 파일로 강제로 덮어쓰는 방법
  - 로컬 변경사항 강제 삭제(main 브런치) : `git reset --hard origin/main`
  - 원격 저장소에서 최신 내용 가져오기 : `git pull`
